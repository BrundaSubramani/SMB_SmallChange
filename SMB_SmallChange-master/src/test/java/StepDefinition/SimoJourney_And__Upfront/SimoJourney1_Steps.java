...
public class SimoJourney1_Steps {
    ...
    Contractterm CT;
    @Then("User is navigated to the Simo page and selects the {int}")
    ...
    @Then("User clicks on the {int} {string} and clicks on continue")
    ...
    ExtrasPage EP;
    @Then("User is navigated to the extras page and selects spend cap {string}  and clicks on next button")
    public void user_is_navigated_to_the_extras_page_and_selects_spend_cap_and_clicks_on_next_button(String string) throws InterruptedException {

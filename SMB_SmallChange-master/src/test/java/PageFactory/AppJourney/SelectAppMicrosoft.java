...
public class SelectAppMicrosoft {

    WebDriver driver;
    public SelectAppMicrosoft(WebDriver driver) {
        this.driver = driver;
    ...
    @FindBy(xpath = "(//*[@class= \"body-link body-link-right\"])[1]")
    WebElement microsoft;

    public  void select_particular_app(){
        ((JavascriptExecutor)driver).executeScript("arguments[0].click()",microsoft);
    }
